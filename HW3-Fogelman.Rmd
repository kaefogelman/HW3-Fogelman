...
```{r create map, include = TRUE}
map <- leaflet() %>% 
  setView(lng = 0.8891, lat = 41.6488, zoom = 5) %>%
  addTiles()
map
```
...
cities <-  read.csv(textConnection("
           City, Lat, Long, Pop
           Madrid, 40.4168, -3.7038, 3400000
           Barcelona, 41.3851, 2.1734, 2600000
           Madrid, 40.4168, -3.7038, 1000000
           Bilbao, 43.2630, -2.9350, 800000
           Valencia, 39.4699, -0.3763, 600000"))
